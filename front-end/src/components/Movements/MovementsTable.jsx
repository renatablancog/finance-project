...
function MovementsTable() {
  const { fetchMonthlySummary, monthlySummary } =
  ...
  return (
    <div className='mx-7 my-6 basis-2/4'>
      <div className='text-l font-bold mb-2 '>Monthly Summary</div>
            ...
            >
              <div className='card-body'>
                <h2 className='card-title'>
                  {moment(month.YearMonth, 'YYYY-MM').format(
                    'MMM-YYYY'
                  )}
                </h2>
                ...
                <h4>
                  Remaining:{' '}
                  {month.TotalIncomes - month.TotalExpenses}
                </h4>
              </div>
            </div>
          );
